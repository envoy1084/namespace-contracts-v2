...
| [BENCHMARKS.md](./BENCHMARKS.md) | Benchmark index and generation command. |
| [PROFILE_BENCHMARKS.md](./PROFILE_BENCHMARKS.md) | Profile gas benchmarks. |
| [SCENARIO_BENCHMARKS.md](./SCENARIO_BENCHMARKS.md) | Scenario gas benchmarks. |
...
Gas benchmarks live under `test/benchmarks/` and are regenerated by:
...
| File | Description |
| --- | --- |
| `BENCHMARKS.md` | Root benchmark index. |
| `PROFILE_BENCHMARKS.md` | Profile-level gas report. |
| `SCENARIO_BENCHMARKS.md` | End-to-end scenario gas report. |
